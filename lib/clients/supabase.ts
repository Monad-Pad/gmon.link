...
const useSchema = false; // This is set to true as on the production version (hosted by Monad Pad) we are using a different schema for the database. When testing locally you can set this to false.
